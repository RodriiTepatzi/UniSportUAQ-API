...
namespace UniSportUAQ_API.Data.Consts
{
    public class ResponseErrors
    {
        ...
        //Attributes
        public static ErrorBase AttributeEmailInvalidlFormat = new ErrorBase { Code = "ATTR001", Description = "Invalid Email format" };
        public static ErrorBase AttributeIdInvalidFormat = new ErrorBase { Code = "ATTR002", Description = "Invalid ID format" };
        ...
        public static ErrorBase SysErrorUserAlreadyThisRole = new ErrorBase { Code = "SYS001", Description = "Only promote a student to either Instructor/Admin." };
        ...
        public static ErrorBase CourseHorarioConflict = new ErrorBase { Code = "COU007", Description = "One or many horarios share day and the active hours are in conflict, try uncrossed hours" };
        ...
        public static ErrorBase InscriptionStudentAlreadyInscripted = new ErrorBase { Code = "INS004", Description = "Not possible inscribe to more than one course, user already insripted in one course" };
        //user prefs
